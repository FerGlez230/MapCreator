...
public class ResolveDialogFragment extends DialogFragment {
  ...
  public static com.example.mapcreator.helpers.ResolveDialogFragment createWithOkListener(OkListener listener) {
    com.example.mapcreator.helpers.ResolveDialogFragment frag = new com.example.mapcreator.helpers.ResolveDialogFragment();
